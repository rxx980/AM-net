...
def cal_miou(test_dir="E:/rxx/code/unet_42-master/rxa/Test_Images",
             pred_dir="E:/rxx/code/unet_42-master/rxa/results", gt_dir="E:/rxx/code/unet_42-master/rxa/Test_Labels"):
    # ---------------------------------------------------------------------------#
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        # 加载模型参数
        net.load_state_dict(torch.load('rxa602双注意力.pth', map_location=device)) # todo
        # 测试模式
        net.eval()
